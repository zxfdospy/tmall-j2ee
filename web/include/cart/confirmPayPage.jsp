...
<div class="confirmPayPageDiv">
    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${o.orderItems}" var="oi">
                <tr>
                    ...
                    <td>￥<fmt:formatNumber type="number" value="${oi.product.originalPrice/100}" minFractionDigits="2"/></td>
                    <td>1</td>
                    <td><span class="conformPayProductPrice">￥<fmt:formatNumber type="number" value="${oi.product.promotePrice/100}" minFractionDigits="2"/></span></td>
        ...
        <div class="confirmPayOrderItemText pull-right">
            实付款： <span class="confirmPayOrderItemSumPrice">￥<fmt:formatNumber type="number" value="${o.total/100}" minFractionDigits="2"/></span>
        </div>

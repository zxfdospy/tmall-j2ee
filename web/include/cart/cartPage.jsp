        ...
        <table class="cartProductTable">
            ...
            <c:forEach items="${ois }" var="oi">
                <tr oiid="${oi.id}" class="cartProductItemTR">
                    ...
                    <td>
                        <span class="cartProductItemOringalPrice">￥${oi.product.originalPrice/100}</span>
                        <span  class="cartProductItemPromotionPrice">￥${oi.product.promotePrice/100}</span>
                    ...
                    <td >
                            ...
                            ￥<fmt:formatNumber type="number" value="${oi.product.promotePrice*oi.number/100}" minFractionDigits="2"/>
                            </span>
